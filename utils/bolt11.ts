// https://github.com/lnbits/lnbits/blob/dev/lnbits/static/js/bolt11-decoder.js

export type Bolt11 = ReturnType<typeof decode>
...
function decodeHumanReadablePart(humanReadablePart: any) {
...
function decodeData(data: any, humanReadablePart: any) {
...
function decodeSignature(signature: any) {
...
function decodeTags(tagData: any) {
...
function decodeTag(type: any, length: any, data: any) {
  switch (type) {
    case 'p':
...
function verify_checksum(hrp: any, data: any) {
  hrp = expand(hrp)
...
function fiveBitArrayTo8BitArray(int5Array: any, includeOverflow?: any) {
  let count = 0
  let buffer = 0
  let byteArray = []
  int5Array.forEach((value: any) => {
...
function bech32ToUTF8String(str: any) {
...
function textToHexString(text: string) {
  let hexString = ''
